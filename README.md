...
# Copy the prompt templates (for Amp, Claude Code, and OpenCode)
...
| `prompts/AMP.md` | Prompt template for Amp |
| `prompts/CLAUDE.md` | Prompt template for Claude Code |
| `prompts/AGENT.md` | Prompt template for OpenCode |
...
After copying `prompt.md` (for Amp or OpenCode) or `CLAUDE.md` (for Claude Code) to your project, customize it for your project:
